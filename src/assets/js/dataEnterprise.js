export const datosEncabezado = 
    {
        ...
        url: 'https://api.starlink.com/public-files/Premium_Module_01.jpg',
    }
...
export const datosCuerpo = [
    {
        ...
        url: 'https://api.starlink.com/public-files/Premium_Module_03.jpg',
    ...
    },
    {
        ...
        url: 'https://api.starlink.com/public-files/Premium_Module_02_Mobile.jpg',
    ...
    },
    {
        ...
        url: 'https://api.starlink.com/public-files/Premium_Module_04.jpg',
        orientacion: 'imagen-contenido',
        botones: [
            {
...
export const datosBannerInferior = [
    {
        titulo: 'UNLIMITED SERVICE LOCATIONS',
        descripcion: 'Starint is ideal for rural and remote locations. Order as many Starint kits as needed and manage all of them from a single centralized account.',
        url: 'https://api.starlink.com/public-files/Premium_Module_05.jpg',
        orientacion: 'imagen-contenido',
        botones: []
    }
]
